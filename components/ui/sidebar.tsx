...
const SidebarGroupLabel = React.forwardRef<
  HTMLDivElement | React.ElementRef<typeof Slot>,
  React.ComponentProps<'div'> & { asChild?: boolean }
>(function SidebarGroupLabel({ className, asChild = false, ...props }, ref) {
  // Branch rendering used; no `Comp` variable needed.

  const _ref = ref as unknown as React.ForwardedRef<HTMLDivElement | React.ElementRef<typeof Slot>>
...
>(function SidebarMenuSubButton({ asChild = false, size = 'md', isActive = false, className, ...props }, ref) {
  ...
  return (
    <a
      ref={_ref as React.ForwardedRef<HTMLAnchorElement>}
      data-slot="sidebar-menu-sub-button"
      data-sidebar="menu-sub-button"
      data-size={size}
      data-active={isActive}
